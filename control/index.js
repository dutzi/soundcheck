...
var seek = function (pos) {
	applescript.execFile(__dirname + "/itunes-seek.applescript", [ pos ], function (err, stdout) {
		if (err) {
			// console.error(err);
		} else {
			// console.log(stdout);
...
var stop = function (pos) {
	applescript.execFile(__dirname + "/itunes-stop.applescript", [ ], function (err, stdout) {
		if (err) {
			// console.error(err);
		} else {
			// console.log(stdout);
...
var saveCover = function (path) {
	applescript.execFile(__dirname + "/itunes-saveCover.applescript", [ path ], function (err, stdout) {
		if (err) {
			// console.error(err);
		} else {
			// console.log(stdout);
